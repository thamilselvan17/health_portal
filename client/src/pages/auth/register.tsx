...
export function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background/50 p-4 relative overflow-hidden py-12">
      <div className="absolute bottom-0 right-0 w-full h-96 bg-primary/10 skew-y-6 origin-bottom-right -z-10"></div>
      ...
      <div className="w-full max-w-md bg-card rounded-3xl shadow-2xl border border-white/50 p-8 z-10 relative overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Button 
            type="submit" 
            className="w-full h-12 rounded-xl text-base font-semibold shadow-lg shadow-primary/20 hover:-translate-y-0.5 transition-all mt-6"
