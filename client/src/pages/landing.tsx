      ...
      <main className="flex-1 pt-20">
        <section className="relative overflow-hidden hero-gradient pt-24 pb-32 px-6 lg:px-12 flex flex-col items-center text-center">
          ...
          <div className="relative z-10 max-w-4xl mx-auto space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 border border-primary/10 shadow-sm mb-4">
          ...
          <div className="relative mt-20 w-full max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl shadow-black/10 border border-white/40">
