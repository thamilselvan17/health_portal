...
export function StudentDashboard() {
  ...
  return (
    <div className="space-y-8">
      <div className="rounded-3xl bg-gradient-to-r from-primary to-blue-500 p-8 text-white shadow-xl shadow-primary/20 relative overflow-hidden">
      ...
      <div className="space-y-4">
        ...
        {isLoading ? (
          <div className="animate-pulse bg-white rounded-2xl h-32 border"></div>
        ) : nextAppointment ? (
